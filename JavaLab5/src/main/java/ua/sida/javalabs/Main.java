...
import ua.sida.javalabs.service.StudentService;
...
public class Main {
    ...
    public static void main(String[] args) throws DBException {
        System.out.println("\nHello in App for Java Lab 5 developed by Yulia Sida 121-20-2");
        ...
        do {
            ...
            switch (userChose) {
                ...
                default -> System.out.println("There is nu such option.Please try again!");
            }
        } while (userChose != 0);
    }
